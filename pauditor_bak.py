...
def ssh_brute(IP_address,Password):
	...
	pass
        ...
        print "Bravo! password found" + "'root':"+ Password
	#add this host to loot DB
	db_entry= "Host:"+ IP_address +"--User:'root'--Pass:" + Password
...
if int(remote_service) == 22 :
	...
	for host in target_host_list :
		print "Brute forcing " + host +" for weak 'root' password...."
	...
	if len(loot_list)== 0:
		print "No week password for user 'root' in all tested host"
